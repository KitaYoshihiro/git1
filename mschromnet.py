...
def MSChromNet(input_shape):
    ...
    x = Conv1DBNRelu(x, net, '12_11', 128)
    x = Conv1DBNRelu(x, net, '12_22', 128)
    x = Conv1DBNRelu(x, net, '12_33', 128)
    x = Upsample1D(x, net, '12')

    x = Conv1DBNRelu(x, net, '13_11', 64)
    x = Conv1DBNRelu(x, net, '13_22', 64)
    x = Conv1DBNRelu(x, net, '13_33', 64)
