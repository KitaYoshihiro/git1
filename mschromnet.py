...
def MSChromNet(input_shape):
    ...
    net['conv3_2'] = Conv1D(16, 3, activation='relu',
                                   padding='same',
                                   name='conv3_2')(net['conv3_1'])
    net['conv3_3'] = Conv1D(16, 3, activation='relu',
                                   padding='same',
                                   name='conv3_3')(net['conv3_2'])
    net['pool3'] = MaxPooling1D(name='pool3')(net['conv3_3'])
    # Block 4
    net['conv4_1'] = Conv1D(32, 3, activation='relu',
                                   padding='same',
                                   name='conv4_1')(net['pool3'])
    net['conv4_2'] = Conv1D(32, 3, activation='relu',
                                   padding='same',
    ...
    net['conv5_2'] = Conv1D(64, 3, activation='relu',
                                   padding='same',
                                   name='conv5_2')(net['conv5_1'])
    net['conv5_3'] = Conv1D(64, 3, activation='relu',
                                   padding='same',
                                   name='conv5_3')(net['conv5_2'])
    net['pool5'] = MaxPooling1D(name='pool5')(net['conv5_3'])
    # Block 6
    net['conv6_1'] = Conv1D(128, 3, activation='relu',
                                    padding='same',
                                    name='conv6_1')(net['pool5'])
    net['conv6_2'] = Conv1D(128, 3, activation='relu',
                                    padding='same',
                                    name='conv6_2')(net['conv6_1'])
    net['conv6_3'] = Conv1D(128, 3, activation='relu',
                                    padding='same',
                                    name='conv6_3')(net['conv6_2'])
    net['pool6'] = MaxPooling1D(name='pool6')(net['conv6_3'])
    # Block 7
    net['conv7_1'] = Conv1D(256, 3, activation='relu',
                                    padding='same',
                                    name='conv7_1')(net['pool6'])
    net['conv7_2'] = Conv1D(256, 3, activation='relu',
                                    padding='same',
                                    name='conv7_2')(net['conv7_1'])
    net['conv7_3'] = Conv1D(256, 3, activation='relu',
                                    padding='same',
    ...
    net['conv8_2'] = Conv1D(512, 3, activation='relu',
                                    padding='same',
                                    name='conv8_2')(net['conv8_1'])
    net['conv8_3'] = Conv1D(512, 3, activation='relu',
                                    padding='same',
                                    name='conv8_3')(net['conv8_2'])
    net['upsample8'] = UpSampling1D(name='upsample8')(net['conv8_3'])

    # Block 9
    net['conv9_1'] = Conv1D(256, 3, activation='relu',
                                    padding='same',
                                    name='conv9_1')(net['upsample8'])
    net['conv9_2'] = Conv1D(256, 3, activation='relu',
                                    padding='same',
                                    name='conv9_2')(net['conv9_1'])
    net['conv9_3'] = Conv1D(256, 3, activation='relu',
                                    padding='same',
                                    name='conv9_3')(net['conv9_2'])
    net['upsample9'] = UpSampling1D(name='upsample9')(net['conv9_3'])
    # Block 10
    net['conv10_1'] = Conv1D(128, 3, activation='relu',
                                    padding='same',
                                    name='conv10_1')(net['upsample9'])
    net['conv10_2'] = Conv1D(128, 3, activation='relu',
                                    padding='same',
                                    name='conv10_2')(net['conv10_1'])
    net['conv10_3'] = Conv1D(128, 3, activation='relu',
                                    padding='same',
                                    name='conv10_3')(net['conv10_2'])
    net['upsample10'] = UpSampling1D(name='upsample10')(net['conv10_3'])
    # Block 11
    net['conv11_1'] = Conv1D(64, 3, activation='relu',
                                    padding='same',
                                    name='conv11_1')(net['upsample10'])
    net['conv11_2'] = Conv1D(64, 3, activation='relu',
                                    padding='same',
                                    name='conv11_2')(net['conv11_1'])
    net['conv11_3'] = Conv1D(64, 3, activation='relu',
                                    padding='same',
                                    name='conv11_3')(net['conv11_2'])
    net['upsample11'] = UpSampling1D(name='upsample11')(net['conv11_3'])
    # Block 12
    net['conv12_1'] = Conv1D(32, 3, activation='relu',
                                    padding='same',
                                    name='conv12_1')(net['upsample11'])
    net['conv12_2'] = Conv1D(32, 3, activation='relu',
                                    padding='same',
                                    name='conv12_2')(net['conv12_1'])
    net['conv12_3'] = Conv1D(32, 3, activation='relu',
                                    padding='same',
    ...
    net['conv13_3'] = Conv1D(16, 3, activation='relu',
                                    padding='same',
                                    name='conv13_3')(net['conv13_2'])
    net['upsample13'] = UpSampling1D(name='upsample13')(net['conv13_3'])
    # Block 14
    net['conv14_1'] = Conv1D(8, 3, activation='relu',
                                    padding='same',
                                    name='conv14_1')(net['upsample13'])
    net['conv14_2'] = Conv1D(8, 3, activation='relu',
                                    padding='same',
                                    name='conv14_2')(net['conv14_1'])
    net['conv14_3'] = Conv1D(8, 3, activation='relu',
                                    padding='same',
